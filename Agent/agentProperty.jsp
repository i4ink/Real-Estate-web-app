...
try {
	...
	statement = connect.createStatement();
        ...
        resultSet = statement.executeQuery("select p.propertyid,p.type,p.price,p.locality_address,p.landmark,p.on_market_date,p.tag,p.locality_pincode,d.BHK,d.size from property p, details d where p.propertyid=d.propertyid and p.agentid="+uid);
