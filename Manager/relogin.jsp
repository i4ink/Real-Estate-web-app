...
.cen {
  ...
  font-family:Verdana, Geneva, Tahoma, sans-serif;
     ...
     <body class="content">
      ...
      <center class="cen"><p><h2><i><b>Manager Login</b></i></h2></p></center>
      <center class="cen"><p><h5 style="color:red;">oops wrong user ID or password please try again</h5></p></center>
        <form method ="get" action="managerResult.jsp"> 
