...
<title>Manager login redirect</title>
</head>
<body>
...
try {
	...
	resultSet = statement.executeQuery("select agentid,pass from agent where name='real_estate_office Manager'");
			 int flag = 0;
				...
				while (resultSet.next()) {
					...
					String nme = "real_estate_office Manager";
