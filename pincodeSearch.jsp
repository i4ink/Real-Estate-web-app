...
try {
    ...
    if(!pcode.equals(""))
    {
        ...
        resultSet = statement.executeQuery("select locality_pincode from property");
        int flag=0;
        while(resultSet.next())
        {
            int t=resultSet.getInt(1);
            if(pin==t || (pin-1)==t || (pin-2)==t || (pin+1)==t || (pin+2)==t)
            {
                flag=1;
                break;
            }
        ...
        <%
            ...
            %>
            <center><h1 style="color:red;padding-top:100px">No properties to show near you</h1></center>
            <%
        }
        ...
        <center> <h1 style="color:red;padding-top:100px">please enter a pincode</h1> </center>
        <%
    }
